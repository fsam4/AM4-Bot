...
### Unfinished features
The source code for v4.9.0 contains some minor new features along with some major ones that were never finished, debugged or released. **The last commit (v5.0.0) can contain some breaking changes**. If you wish to browse the source code for the final version of v4.9.0, you can do it [here](https://github.com/fsam4/AM4-Bot/tree/12d7383dc0e3260c935102045c33c46a3c8fd221).

Below is a list of some new features that were never released to AM4 Bot, and might not be finished or debugged:
